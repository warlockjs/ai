...
- Suite: **176 files / 1909 tests passing**, including the regression tests for each of the security fixes above (24 for the supervisor fan-out cap and the state-merge guard alone)
